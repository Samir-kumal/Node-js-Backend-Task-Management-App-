...
const { createUser, loginUser,getUser,validateUserPassword,updatePassword, updateUserName,deleteUser } = require("../controllers/userController");
const authenticateToken = require("../middlewares/authenticateToken");
router.route("/register").post(createUser);
router.route("/login").post(loginUser);
router.route("/getUser").get(authenticateToken,getUser);
router.route("/validateUserPassword").post(authenticateToken,validateUserPassword);
